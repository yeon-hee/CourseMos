...
>>>>>>> 3dc189a6b5fc1d14e82123639ac3c9f473c3228d
...
#map{display: block;}
#menu_wrap {display:block;position:relative;;top:0;left:0;bottom:0;width:250px;margin:10px 0 30px 10px;padding:5px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
=======
