...
const changeProfileImage = (data, callback, errorCallback) => {
    axios.put(url.url + "/users/profile/image", data, { headers: { "Authorization": data.token } })
        .then((res) => callback(res))
        .catch((res) => errorCallback(res));
}
...
const UserApi = {
    ...
    changeProfileImage: (data, callback, errorCallback) => changeProfileImage(data, callback, errorCallback),
